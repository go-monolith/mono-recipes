...
func NewModule() *ArticleModule {
	...
	if dbURL == "" {
		...
		dbURL = "postgres://postgres:postgres@localhost:51214/template1?schema=article_module&sslmode=disable&connection_limit=1&connect_timeout=0&max_idle_connection_lifetime=0&pool_timeout=0&single_use_connections=true&socket_timeout=0"
