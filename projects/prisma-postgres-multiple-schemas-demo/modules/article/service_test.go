...
type mockRepository struct {
	articles                 map[uuid.UUID]*generated.ArticleModuleArticle
...
func newMockRepository() *mockRepository {
	return &mockRepository{
		articles:  make(map[uuid.UUID]*generated.ArticleModuleArticle),
		slugIndex: make(map[string]uuid.UUID),
	}
}

func (m *mockRepository) Create(_ context.Context, title, content, slug string, published bool) (*generated.ArticleModuleArticle, error) {
	if m.createErr != nil {
	...
	id := uuid.New()
	now := time.Now()
	article := &generated.ArticleModuleArticle{
...
func (m *mockRepository) FindByID(_ context.Context, id uuid.UUID) (*generated.ArticleModuleArticle, error) {
...
func (m *mockRepository) FindBySlug(_ context.Context, slug string) (*generated.ArticleModuleArticle, error) {
...
func (m *mockRepository) FindAll(_ context.Context, limit, offset int32) ([]generated.ArticleModuleArticle, error) {
	if m.findAllErr != nil {
		return nil, m.findAllErr
	}

	articles := make([]generated.ArticleModuleArticle, 0, len(m.articles))
	...
	if start >= len(articles) {
		return []generated.ArticleModuleArticle{}, nil
	}
...
func (m *mockRepository) FindAllByPublished(_ context.Context, published bool, limit, offset int32) ([]generated.ArticleModuleArticle, error) {
	if m.findAllByPublishedErr != nil {
		return nil, m.findAllByPublishedErr
	}

	articles := make([]generated.ArticleModuleArticle, 0)
	for _, a := range m.articles {
...
func (m *mockRepository) Update(_ context.Context, id uuid.UUID, title, content, slug *string, published *bool) (*generated.ArticleModuleArticle, error) {
	if m.updateErr != nil {
...
func (m *mockRepository) Publish(_ context.Context, id uuid.UUID) (*generated.ArticleModuleArticle, error) {
	if m.publishErr != nil {
...
func TestArticleService_ErrorPropagation(t *testing.T) {
	...
	t.Run("get propagates repository error", func(t *testing.T) {
		...
		id := uuid.New()
		repo.articles[id] = &generated.ArticleModuleArticle{
			ID: pgtype.UUID{Bytes: id, Valid: true},
		}
